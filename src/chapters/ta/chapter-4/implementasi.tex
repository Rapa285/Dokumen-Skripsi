...
berdasarkan \textit{event source} ditunjukkan pada Tabel~\ref{tab:oevent-source-distribution}.

Perlu dicatat bahwa \textit{event} EV8 (IOTA Transaction Submission) dan EV9
(Gas Sponsorship Request) tercatat pada sisi pemohon, bukan pada Gas Station
Server.