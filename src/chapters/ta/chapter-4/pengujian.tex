...
Hasil pengujian menunjukkan seluruh tiga indikator terpenuhi. CID yang dihasilkan oleh IPFS dapat digunakan untuk mengambil kembali berkas arsip melalui \textit{gateway} IPFS, dan \textit{object ID} \texttt{LogRecord} pada IOTA dapat diverifikasi melalui IOTA Explorer pada jaringan Localnet.
...
Pengujian KNF-TA-03 memastikan ketersediaan dan keteraksesan data \textit{audit trail} dalam jangka panjang melalui kombinasi \textit{IPFS pinning} dan penyimpanan metadata \textit{on-chain} pada IOTA.
