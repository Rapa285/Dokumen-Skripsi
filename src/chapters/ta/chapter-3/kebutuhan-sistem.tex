...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{2cm}|p{11.5cm}|}
        ...
        \hline
        KF-TA-04 & Sistem harus menyimpan rekaman \textit{audit trail} ke dalam media penyimpanan yang bersifat \textit{append-only} untuk mencegah modifikasi (\textit{overwrite}). \\
        \hline
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{2cm}|p{11.5cm}|}
        ...
        \textbf{ID} & \textbf{Deskripsi Kebutuhan} \\
        \hline
        KNF-TA-01 & \textbf{Integritas:} Sistem harus menjamin bahwa data \textit{audit record} yang telah disimpan bersifat \textit{tamper-proof} dan tidak dapat diubah atau dihapus oleh pihak mana pun. \\
        \hline
        ...
        \hline
        KNF-TA-03 & \textbf{Ketersediaan Data:} Sistem harus menjamin ketersediaan dan keteraksesan data \textit{audit trail} dalam jangka panjang. \\
        \hline
