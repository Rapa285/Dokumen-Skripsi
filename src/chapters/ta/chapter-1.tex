...
\begin{enumerate}
\item Peristiwa (\textit{event}) apa saja yang perlu dicatat oleh mekanisme audit trail pada sistem DecMed?
\item Bagaimana rancangan dan implementasi layanan audit trail yang sesuai dengan arsitektur DecMed?
\end{enumerate}
...
\item Merancang dan mengimplementasikan layanan audit trail yang terintegrasi dengan arsitektur DecMed.
\end{enumerate}
